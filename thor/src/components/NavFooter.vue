  ...
  <div class="container">
						<div class="main-footer">
							<div class="row col-12 m-0 align-items-start justify-content-between">
								<div class="col-md-4 p-0">
									<div class="brand">
										<div class="brand-logo">
											<img src="../assets/static/images/logo.png" alt="" class="img-fluid" />
										</div>
										<div class="brand-text">
											<span
												>Get Massive Traction that Converts to More Followers, Subscribers and More Views on your Blogs</span
											>
										</div>
								...
								<div class="col-md-3 p-0 company-links">
								...
								<div class="col-md-4 p-0">
									<div class="newsletter">
										...
										<div class="text-small">
											<span>We will send you weekly updates on new developments, articles and features</span>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="post-footer">
							<div class="row justify-content-center align-items-center">
								<div class="p-0 text-center col-md-4">
									<span><small>Copyright Etentlabs 2022 All Rights Reserved </small></span>
								</div>
								<div class="p-0 col-md-3 d-none d-md-inline-flex">
									<span><small>Developed by Etentlabs</small></span>
								</div>
							</div>
						</div>
					</div>
...
<style scoped>
@import "@/assets/static/css/styles/nav.css";
@import "@/assets/static/css/styles/footer.css";
</style>
