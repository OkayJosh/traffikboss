<template>
  <div class="main-inner">
    <div class="hero-section">
      <div class="hero-section-inner row col-12 m-0 align-items-center">
								<div class="col-md-5">
									<div class="content" data-aos="zoom-in-right" data-aos-delay="300">
										<div class="content-inner">
											<h1><b>Our Content</b></h1>
											<div class="sub-text">
												<span>
													Get Massive Traction for your Follow, Subscription and traffic campaign on your social platforms
												</span>
											</div>
										</div>
									</div>
								...
								<div class="col-md-7">
									<div class="image text-center" data-aos="zoom-in-left" data-aos-delay="500">
										<img src="../assets/static/images/support.png" alt="" class="img-fluid" />
									</div>
								</div>
							</div>
    </div>
    <div class="padding-giver">
									...
									<div class="form-wrapper">
										<div class="row col-12 m-0 align-items-start justify-content-between">
											<div class="p-0 col-md-5">
												<div class="pre-form">
													<div><span>Send us a message and our team will back to you within 24 hours</span></div>
															...
															<div class="phone">
																<span>
																	<svg
																		...
																		<path
																			fill="currentColor"
																			d="m494.643 412.121l-75.959-75.959c-21.322-21.322-55.892-21.322-77.215 0l-11.884 11.884a71.049 71.049 0 0 0-19.157 34.794c-25.747.481-54.864-3.897-79.768-20.054a390.981 390.981 0 0 1-43.219-37.321a392.97 392.97 0 0 1-31.966-36.134c-19.409-26.076-24.531-57.721-24.013-85.456a71.04 71.04 0 0 0 34.794-19.157l11.884-11.884c21.322-21.322 21.322-55.892 0-77.215L102.181 19.66c-14.215-14.215-37.262-14.215-51.476 0L37.664 32.704C20.946 49.422 12.388 71.196 11.943 93.105c-4.281 46.225 4.572 97.111 25.603 147.158c13.886 33.044 32.951 65.309 56.17 95.299c.293.392.571.789.868 1.18l.034-.026a468.947 468.947 0 0 0 38.271 43.304a471.389 471.389 0 0 0 44.827 39.503l-.152.201a185.851 185.851 0 0 0 8.033 5.761c66.261 49.01 141.154 76.545 210.847 76.541c4.071-.001 8.129-.117 12.165-.306c25.959 3.191 53.065-5.152 72.992-25.079l13.043-13.043c14.214-14.215 14.214-37.262-.001-51.477z" />
																	</svg>
																</span>
																<span> +2348012876487 </span>
															</div>
															<div class="email">
																<span>
																	<svg
																...
																<span> angel@traffickboss.com </span>
															</div>
														</div>
														<div class="socials">
															<div class="title">
												...
												<div class="form-wrapper-inner">
													<form action="">
														...
														<div class="form-input">
															...
															<input type="tel" class="form-control" id="phone" placeholder="+234 00 0000 0000" />
														</div>
														<div class="form-input">
...
<script>
import FAQ from '@/components/FaqMain.vue'
